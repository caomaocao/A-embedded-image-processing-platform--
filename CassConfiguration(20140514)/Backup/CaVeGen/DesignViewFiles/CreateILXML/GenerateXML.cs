...
namespace CaVeGen.DesignViewFiles
{
    class GenerateXML
    {
        ...
        public void CreateProjectXML(List<string> TempInfo, List<string[]> addressInfo, List<ControlInfo> ctrllist, List<string[]> IOList)
        {
            ...
            {
                if (ctrl.CodeInfo != null && !GenerateCode.SortCtrlName.Contains(ctrl.CodeInfo[0]))
