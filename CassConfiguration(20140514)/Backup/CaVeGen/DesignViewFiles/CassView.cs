...
namespace CaVeGen.DesignViewFiles
{
    ...
    public partial class CassView : UserControl
    {
        ...
        static public List<string> OnlyOneOut = new List<string>(new string[] { "常数", "系统变量", "输入变量", "AD转化" });//只有一个输出口
        static public List<string> OnlyOneIn = new List<string>(new string[] { "输出变量", "跳转", "调用", "返回", "DA转化" });//只有一个输入口
