...
{
    public partial class DAControl : UserControl
    {      
        ...
        private string moduleSort = "DA转换";
        [Category("基本属性")]
        [Browsable(false)]
