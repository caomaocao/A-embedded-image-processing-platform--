...
{
    public partial class CanAddIO : UserControl
    {
        public CanAddIO()
        {
        ...
        public int InputNum
        {
            ...
            {
                this.inputNum = value;
                this.inputportName = new List<string>();
                for (int i = 0; i < inputNum; i++)
                {
                    inputportName.Add(original_InputName + i.ToString());
                }
        ...
        public int OutputNum
        {
            ...
            set
            {
                ...
                this.outputportName = new List<string>();               
                for (int i = 0; i < outputNum; i++)
                {
                    outputportName.Add(original_OutputName + i.ToString());
                }
                ChangeControlSize();        //根据输入内容调整控件大小
                DrawModuleImage();      //重新绘制控件图片
            }
        ...
        ///// 输入端口名称
        ///// </summary>
        private List<string> inputportName = new List<string>(new string[] { "IN0","IN1" });
        private string original_InputName = "IN";
        //[Category("基本属性")]
        //[Browsable(false)]
        //[DisplayName("输入端口")]
        ...
        ///// 输出端口名称
        ///// </summary>
        private List<string> outputportName = new List<string>(new string[] { "OUT0","OUT1" });
        private string original_OutputName = "OUT";
        //[Category("基本属性")]
        //[Browsable(false)]
        //[DisplayName("输出端口")]
        ...
        public Point MouseMovePoint
        {
            ...
            set
            {
                ...
                {
                    for (int i = 0; i < this.inputportName.Count; i++)
                    {
                ...
                {
                    for (int i = 0; i < this.outputportName.Count; i++)
                    {
        ...
        {
            if (this.inputportName.Count > this.outputportName.Count)
            {
                this.originalSize.Height = 43 + 15 * this.inputportName.Count;
                this.Height = Convert.ToInt32(this.originalSize.Height * this.scaling);
            }
            else
            {
                this.originalSize.Height = 43 + 15 * this.outputportName.Count;
                this.Height = Convert.ToInt32(this.originalSize.Height * this.scaling);
            }
