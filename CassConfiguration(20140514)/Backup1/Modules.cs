...
namespace ControlTactic
{
    public partial class Modules : UserControl
    {
        ...
        /// 模块名称
        /// </summary>
        private string moduleTitle = "ADD";
        ...
        /// 输入端口名称
        /// </summary>
        private string[] inputportName = new string[3] { "EN", "IN0", "IN1" };
        ...
        public Modules()
        {
            ...
            this.Resize += new EventHandler(Modules_Resize);        //为控件加载控件大小变化事件处理函数
        }
        ...
        private void Modules_Resize(object sender, EventArgs e)
        {
