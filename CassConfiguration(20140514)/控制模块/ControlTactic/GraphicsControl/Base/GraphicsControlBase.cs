...
{
    public partial class GraphicsControlBase : UserControl
    {
        ...
        public GraphicsControlBase()
        {
            ...
            this.Resize += new EventHandler(GraphicsControlBase_Resize);        //为控件加载控件大小变化事件处理函数
        }

        private string showName = null; //控件显示名称 20140224
        ...
        private void GraphicsControlBase_Resize(object sender, EventArgs e)
        {
