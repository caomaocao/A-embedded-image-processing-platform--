...
{
    public partial class Sobel : GraphicsControlBase
    {
        public Sobel()
        {
            base.ShowName = "Sobel";
        ...
        ///// 模块名称
        ///// </summary>
        //private string moduleTitle = "Sobel";
        ...
        //    this.Resize += new EventHandler(Sobel_Resize);        //为控件加载控件大小变化事件处理函数
        //}
        ...
        //private void Sobel_Resize(object sender, EventArgs e)
        //{
