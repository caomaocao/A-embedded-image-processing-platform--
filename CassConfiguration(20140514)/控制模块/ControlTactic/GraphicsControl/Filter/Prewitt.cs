...
{
    public partial class Prewitt : GraphicsControlBase
    {
        public Prewitt()
        {
            base.ShowName = "Prewitt";
            InitializeComponent();
        }
        ...
        ///// 模块名称
        ///// </summary>
        //private string moduleTitle = "Prewitt";
        ...
        //    this.Resize += new EventHandler(Prewitt_Resize);        //为控件加载控件大小变化事件处理函数
        //}
        ...
        //private void Prewitt_Resize(object sender, EventArgs e)
        //{
        ...
        //    SizeF size = g.MeasureString(this.moduleTitle, this.font_Title);
        //    this.titlePoint.X = Convert.ToInt32((this.originalSize.Width - size.Width) / 2);
        //    g.DrawString(this.moduleTitle, this.font_Title, this.brush_Title, this.titlePoint);
        //    if (this.showNumber)
        //    {
