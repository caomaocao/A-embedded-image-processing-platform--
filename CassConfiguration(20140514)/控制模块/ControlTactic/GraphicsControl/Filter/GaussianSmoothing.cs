...
{
    public partial class GaussianSmoothing : UserControl
    {
        ...
        private Size originalSize = new Size(110, 75);     //控件初始大小
        
        //显示名
        private string showName = "Gaussian";
        ...
        /// 模块名称
        /// </summary>
        private string moduleTitle = "GaussianSmoothing";
        ...
        /// 输入端口名称
        /// </summary>
        private string[] inputportName = new string[1] { "Input" };
        ...
        /// 输出端口名称
        /// </summary>
        private string[] outputportName = new string[1] { "Output" };
        private string original_OutputName = "Output";
        [Category("基本属性")]
        [Browsable(false)]
        [DisplayName("输出端口")]
        ...
        public GaussianSmoothing()
        {
            ...
            this.Resize += new EventHandler(Gaosi_Resize);        //为控件加载控件大小变化事件处理函数
        }
        ...
        private void Gaosi_Resize(object sender, EventArgs e)
        {
        ...
        private void DrawModuleImage()
        {
            ...
            SizeF size = g.MeasureString(this.showName, this.font_Title);
            this.titlePoint.X = Convert.ToInt32((this.originalSize.Width - size.Width) / 2);
            g.DrawString(this.showName, this.font_Title, this.brush_Title, this.titlePoint);
            if (this.showNumber)
            {
        ...
        private void ChangeControlSize()
        {
            ...
            {
                this.originalSize.Height = 30 + 15 * this.inputportName.Length;
                this.Height = Convert.ToInt32(this.originalSize.Height * this.scaling);
            }
            else
            {
                this.originalSize.Height = 30 + 15 * this.outputportName.Length;
                this.Height = Convert.ToInt32(this.originalSize.Height * this.scaling);
            }
