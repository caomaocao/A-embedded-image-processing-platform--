...
{
    public class ChooseProperty : UITypeEditor
    {     
        public static List<string[]> ShowProtertyName = new List<string[]>();
        ...
        public override object EditValue(ITypeDescriptorContext context, IServiceProvider provider, object value)
        {
            ...
            if (editorService != null)      //编辑服务类型不为空
            {
                ...
                foreach (string[] property in ChooseProperty.ShowProtertyName)
                { 
                    this.listBox.Items.Add(property[0]); 
                }
