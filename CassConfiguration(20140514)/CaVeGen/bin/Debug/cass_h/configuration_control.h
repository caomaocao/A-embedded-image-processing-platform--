...
typedef struct space_number_info_ 
{
	unsigned short leftbound;          //左上角宽度坐标
...
//匹配
extern uint8 WORKMATCHControl(WORKMATCHStruct *MATCH);
extern uint8 NUMMATCHControl(NUMMATCHStruct *MATCH);
//
