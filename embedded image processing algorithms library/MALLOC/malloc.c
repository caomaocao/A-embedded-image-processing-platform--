...
__align(4) u8 raw_data[76800] __attribute__((at(0X68000000+2*MEM2_MAX_SIZE)));
__align(4) u8 out_data[76800] __attribute__((at(0X68000000+4*MEM2_MAX_SIZE)));
__align(4) u8 ComOutBuf[76806] __attribute__((at(0X68000000+6*MEM2_MAX_SIZE)));
__align(4) u8 temp_data[76800] __attribute__((at(0X68000000+8*MEM2_MAX_SIZE)));
