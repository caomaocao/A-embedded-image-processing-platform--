...
#define USART_SND_LEN 76806  //76800 + modbus format
...
void UartRecvDataHandle() //标准MOD-BUD
{
	...
	{
		pComOutBuf[2] = 320%255;  //weight
		pComOutBuf[3] = 320/255;  //weight
		pComOutBuf[4] = 240%255;  //height
		pComOutBuf[5] = 240/255;  //height
		memcpy(pComOutBuf+6, out_data , 320 * 240) ;
		ComOutDataLen =320*240+6;
		return;
	}
